...
clear all;
% set variables
Block = '~20180907_ABBA_d01'; % frequency task
FileName_LabVIEW = 'domo_frq_dynamic_2018090701';
% Block = '~20180905_ABBAl_d01'; % location task
% FileName_LabVIEW = 'domo_frq_dynamic_sp2n5_2018090701';
...
SF = 1017.25; % sampling freq for stim, lever, rew, and lfp
