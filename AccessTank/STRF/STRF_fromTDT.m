...
Block = '~20180709_Ripple_d02'; % v-probe
...
%         [taxis,faxis,STRF1A,STRF2A,PP,Wo1A,Wo2A,No1A,No2A,SPLN]=rtwstrfdb('C:\STRF_files\ripple_96k\DNR_Cortex_96k5min.spr',0,0.15,spet,TrigA,fs,80,30,'dB','MR',300,'float');
        [taxis,faxis,STRF1A,STRF2A,PP,Wo1A,Wo2A,No1A,No2A,SPLN]=rtwstrfdbint('C:\STRF_files\ripple_96k\DNR_Cortex_96k5min.spr',0,0.15,spet,TrigA,fs,80,30,'dB','MR',1700,5,'float');
...
%         [taxis,faxis,STRF1B,STRF2B,PP,Wo1B,Wo2B,No1B,No2B,SPLN]=rtwstrfdb('C:\STRF_files\ripple_96k\DNR_Cortex_96k5min.spr',0,0.15,spet,TrigB,fs,80,30,'dB','MR',300,'float');
        [taxis,faxis,STRF1B,STRF2B,PP,Wo1B,Wo2B,No1B,No2B,SPLN]=rtwstrfdbint('C:\STRF_files\ripple_96k\DNR_Cortex_96k5min.spr',0,0.15,spet,TrigB,fs,80,30,'dB','MR',1700,5,'float');
