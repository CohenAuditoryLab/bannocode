...
for ff=1:length(LIST_DATE_A1)
    ...
    a1.stdiff = [a1.stdiff; AvsB.stdiff(:)];
    a1.group = [a1.group; AvsB.group(:)];
...
for ff=1:length(LIST_DATE_BELT)
    ...
    belt.stdiff = [belt.stdiff; AvsB.stdiff(:)];
    belt.group = [belt.group; AvsB.group(:)];
...
set(gca,'xTickLabel',{'supra','granular','infra'},'ylim',[0 6]);
x_lim = get(gca,'xlim');
% xlabel('layer');
