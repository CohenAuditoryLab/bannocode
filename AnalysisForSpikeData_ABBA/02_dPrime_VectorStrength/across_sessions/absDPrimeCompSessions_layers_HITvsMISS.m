...
a1_group = ones(1, size(a1_data,2)); % compare hit vs miss -> only one level
...
belt_group = ones(1, size(belt_data,2)); % level
...
set(gca,'xTickLabel',{'supra','granular','infra'},'ylim',[0 3.5]);
x_lim = get(gca,'xlim');
% xlabel('layer');
