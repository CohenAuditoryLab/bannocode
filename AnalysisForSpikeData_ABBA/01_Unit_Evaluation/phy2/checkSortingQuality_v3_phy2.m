...
% BLOCK_NAME = '20180905_ABBAl_d01';

% DATA_PATH = fullfile('F:\kilosort_Domo',BLOCK_NAME);
DATA_PATH = fullfile('/Volumes/TOSHIBA_EXT/Kilosort/Cassius',BLOCK_NAME);
...
addpath(['/Volumes/TOSHIBA_EXT/01_STREAMING/CassiusBehavior/',BLOCK_NAME(1:8)]);
...
% [cids,~,ch,~,~,cgs,~,~] = readClusterInfoCSV('cluster_info.tsv'); % cluster group
