...
% set variables
isSave = 0; % 0 - not save figure, 1 - save figure...
type = 'Selectivity'; %'TvsNT'; % 'Adaptation'
BrainArea = 'Core'; % either Core or Belt...
cRange = [0 24]; % 24ch electrode

% fixed variables
save_file_name = strcat(type,'_Cassius_',BrainArea);
...
% list all sessions from Cassius
if strcmp(BrainArea,'Core')
    list_session = {'20201127','20201202','20201214','20210106', ...
        '20210111','20210208','20210210','20210306','20210317', ...
        '20210403'}; % assignment not sure yet...
elseif strcmp(BrainArea,'Belt')
    list_session = {'20201123','20201221','20210104','20210213' ...
        '20210220','20210222','20210224','20210308','20210310', ...
        '20210313','20210324','20210331'};
end
...
% % figure only for 'Adaptation' and 'TvsNT'
