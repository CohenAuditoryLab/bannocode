...
%     end
    ...
    save_file_dir = fullfile(root_save_file_dir,folder,layer,strcat('zScore_',s_triplet{tpos}));
    ...
    if strcmp(auditory_area,'All')
        ...
        save(fullfile(root_save_file_dir,folder,layer,save_file_name),'sigRESP','SIG','PREF','p','area_index');
    end
end