...
for ff=1:numel(list_RecDate)
    ...
    fName1 = strcat(RecDate,'_zMUAtriplet_emergence');
...
%     iBAT = val'; % transpose to make the first dim to be channels
    ...
    save_file_name = strcat(RecDate,'_MUAProperty2_emergence');
    save(fullfile(data_dir,save_file_name),'SMI','BMI','sig_ch','ch_L3u','ch_L3','ch_L5','i_area');
end