...
H(1) = figure;
subplot(2,2,1);
dBehav_Ac = plot_index_emergence(rCORE_A,'Behav'); hold on;
dBehav_Ab = plot_index_emergence(rBELT_A,'Behav');
title('A');

subplot(2,2,3);
dBehav_B1c = plot_index_emergence(rCORE_B1,'Behav'); hold on;
dBehav_B1b = plot_index_emergence(rBELT_B1,'Behav');
title('B1');

subplot(2,2,4);
dBehav_B2c = plot_index_emergence(rCORE_B2,'Behav'); hold on;
dBehav_B2b = plot_index_emergence(rBELT_B2,'Behav');
title('B2');
...
H(2) = figure;
subplot(2,2,1);
dStim_Ac = plot_index_emergence(rCORE_A,'Stim'); hold on;
dStim_Ab = plot_index_emergence(rBELT_A,'Stim');
title('A');

subplot(2,2,3);
dStim_B1c = plot_index_emergence(rCORE_B1,'Stim'); hold on;
dStim_B1b = plot_index_emergence(rBELT_B1,'Stim');
title('B1');

subplot(2,2,4);
dStim_B2c = plot_index_emergence(rCORE_B2,'Stim'); hold on;
dStim_B2b = plot_index_emergence(rBELT_B2,'Stim');
title('B2');
...
% save figures...
save_dir = fullfile(DATA_PATH,'Emergence','CompAreas');
