...
ROOT_PATH = 'E:\01_Research\01_STREAM_INTEGRATION&SEGREGATION\ANALYSIS\MUA\Results\AcrossSessions\Response\Depth';
layer = 'Sup'; % either 'Deep' or 'Sup'
auditory_area = 'Belt'; % either 'Core', 'Belt', or 'All'
% sTriplet = {'1st','2nd','3rd','Tm1','T'};
sTriplet = {'Tm3','Tm2','Tm1','T'};

DATA_PATH = fullfile(ROOT_PATH,layer);
...
% save figure...
save_dir = 'E:\01_Research\01_STREAM_INTEGRATION&SEGREGATION\ANALYSIS\MUA\Results\AcrossSessions\Response\Emergence';
save_file_name = strcat(animal_name,'_zMUAResp_',layer,'_',auditory_area);
saveas(gca,fullfile(save_dir,layer,save_file_name),'png');
