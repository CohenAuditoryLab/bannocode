function [ p_friedman ] = stats_CompLayerArea_Friedman( index )
...
sb_string = ones(n_sup_belt,n_tpos); % matrix of 1
dc_string = ones(n_deep_core,n_tpos)*2; % matrix of 2
db_string = ones(n_deep_belt,n_tpos)*3; % matrix of 3
