function [index] = display_Index_LayerArea(index_core,index_belt,Type)
...
tpos = {'1st','2nd','3rd','T-1','T'}; n_tpos = length(tpos);
...
errorbar((1:n_tpos)+jitter(3),mDeep_core,eDeep_core,'Color',color_core(2,:),'LineWidth',1.5);
errorbar((1:n_tpos)+jitter(4),mDeep_belt,eDeep_belt,'Color',color_belt(2,:),'LineWidth',1.5);
