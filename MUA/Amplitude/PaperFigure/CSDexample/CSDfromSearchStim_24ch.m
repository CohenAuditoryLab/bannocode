...
% TankName = ['Domo-180227-115025'];%hardwired answer
Date = '20210410';
TankDir = 'D:\TDT\Tanks\';%hardwired answer
TankName = strcat('Cassius-',Date(3:end));%hardwired answer
% Block = strcat(Date,'_SearchStim_test');
Block = strcat(Date,'_SearchStim_d04');
...
nChannel = 24; % number of channels
...
% ACCESSING TANK FILE
% data = TDTbin2mat('F:\TDT\Synapse\Tanks\Domo-180807\20180807_SearchStim_d01','TYPE',{'epocs','streams'},'CHANNEL',0);
