function [ d_reshape, h ] = plot_index_layer( sigRESP_layer, jitter, BorS )
...
% dStim = abs( Rhh - Reh)./ abs( Rhh + Reh ) + abs( Rhm - Rem )./ abs( Rhm + Rem ); 
% dBehav = ( Rhh - Rhm )./ abs( Rhh + Rhm ) + ( Reh - Rem )./ abs( Reh + Rem );
