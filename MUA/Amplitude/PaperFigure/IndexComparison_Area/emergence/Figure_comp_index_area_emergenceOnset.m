...
addpath('C:\Users\Taku\Documents\01_Research\01_STREAM_INTEGRATION&SEGREGATION\ANALYSIS\MUA\code\Amplitude\PaperFigure\IndexComparison_Area\emergence\onset\triplet_mean');
addpath('C:\Users\Taku\Documents\01_Research\01_STREAM_INTEGRATION&SEGREGATION\ANALYSIS\MUA\code\Amplitude\PaperFigure\IndexComparison_Area\ttime');
...
% plot figure
subplot(2,2,3);
dBehav = display_Index_area_ttime_figure(rCORE,rBELT);


% export figure
exportgraphics(gcf,fullfile(SAVE_DIR,'BMI_rTarget.eps'),'Resolution',600);