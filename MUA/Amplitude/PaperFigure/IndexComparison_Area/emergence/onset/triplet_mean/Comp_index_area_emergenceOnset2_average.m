...
figure;
subplot(2,2,1);
plot_IndexAverage_area_emergenceOnset_wBL(mSMI_core_wBL,-jitter,'Stim',line_color(1,:));
plot_IndexAverage_area_emergenceOnset_wBL(mSMI_belt_wBL,jitter,'Stim',line_color(2,:));

figure;
subplot(2,2,1);
plot_IndexAverage_area_emergenceOnset_wBL(mBMI_core_wBL,-jitter,'Behav',line_color(1,:));
plot_IndexAverage_area_emergenceOnset_wBL(mBMI_belt_wBL,jitter,'Behav',line_color(2,:));

p_behav = stats_CompLayers_emergenceOnset_Friedman(mBMI_core_wBL,mBMI_belt_wBL);
% p_stim = stats_CompLayers_emergenceOnset_Friedman(mSMI_core_wBL,mSMI_belt_wBL);
