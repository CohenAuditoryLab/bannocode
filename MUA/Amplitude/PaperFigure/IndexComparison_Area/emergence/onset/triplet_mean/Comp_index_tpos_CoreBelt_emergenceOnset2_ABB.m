...
% 5/16/22 modified
% statistical comparison...
pStim_core = kruskalwallis(smi_core,[],'off');
pStim_belt = kruskalwallis(smi_belt,[],'off');
[pBehav_core, tbl_core] = kruskalwallis(bmi_core,[],'off');
[pBehav_belt, tbl_belt] = kruskalwallis(bmi_belt,[],'off');
