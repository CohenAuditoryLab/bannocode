...
pBMI_core = kruskalwallis(dBehav.ABB.c);
pBMI_belt = kruskalwallis(dBehav.ABB.b);

pSMI_core = kruskalwallis(dStim.ABB.c(:,1:3:end));
pFMI1_core = kruskalwallis(dStim.ABB.c(:,2:3:end));
pFMI2_core = kruskalwallis(dStim.ABB.c(:,3:3:end));
pSMI_belt = kruskalwallis(dStim.ABB.b(:,1:3:end));
pFMI1_belt = kruskalwallis(dStim.ABB.b(:,2:3:end));
pFMI2_belt = kruskalwallis(dStim.ABB.b(:,3:3:end));
