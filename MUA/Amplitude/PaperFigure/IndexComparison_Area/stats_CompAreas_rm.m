function [ p_anova, p_posthoc ] = stats_CompAreas_rm( d_core, d_belt )
...
varNames = {'Area','t1','t2','t3','t4','t5'};
t = table(Area,Y(:,1),Y(:,2),Y(:,3),Y(:,4),Y(:,5), ...
    'VariableNames',varNames);

% fit the repeated measures model
rm = fitrm(t,'t1-t5~Area','WithinDesign',Tpos);
