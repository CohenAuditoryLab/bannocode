...
tpos = 3; % triplet position (either 1, 2, or 3)
...
%     [sig,sigResp,resp,depth] = get_MUASignificance_tpos(rec_date,L3_ch,tpos,isSave);
    [sig,sigResp,resp,depth] = get_MUASignificance_tpos(rec_date,L3_ch,tpos,0); % do not save figure
...
s_triplet = {'1stTriplet','2ndTriplet','3rdTriplet'};
if isSave==1
