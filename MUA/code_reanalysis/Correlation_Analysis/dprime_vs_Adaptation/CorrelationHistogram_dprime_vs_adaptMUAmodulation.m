...
load(fullfile(path_roc,strcat('ROC_Both_AdaptDev_A_',BF_Session,'BF_wIntermDF')));
...
load(fullfile(path_dp,strcat('BehavioralDPrime_',BF_Session,'BF_wIntermDF')));
if v==1
    disp(['Correlation type: ',c_type]);
    disp('version 1: choose B1 for non-BF sites');
    load(fullfile(path_roc,strcat('ROC_Both_AdaptDev_B1_',BF_Session,'BF_wIntermDF')));
elseif v==2
    disp(['Correlation type: ',c_type]);
...
set(gca,'XTick',[1 2],'XTickLabel',x_label,'XLim',[0.5 2.5]);
