...
y_top = -2; y_btm = -1; % copied from yrange_top and yrange_btm
...
% % export graphics (high resolution image)
% f = gcf;
% exportgraphics(f,'20210111_exampleMUA_ch23_ver2_wStim.jpg','Resolution',600);