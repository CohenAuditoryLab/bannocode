function [SMI,BMI] = get_SMIBMI_v3(rALL_ABB,area_index,AP_index,nBoot)
...
% % get_BootIndex
function [smi,bmi] = get_BootIndex(rALL,nBoot)
...
smi = ( Rhh - Reh ) + ( Rhm - Rem ); % hard (small dF) - easy (large dF)
