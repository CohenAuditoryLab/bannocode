...
[SMI_A,BMI_A] = get_SMIBMI_v2(rA_all,area_index,AP_index,nBoot,'A');
[SMI_B1,BMI_B1] = get_SMIBMI_v2(rB1_all,area_index,AP_index,nBoot,'B1');
[SMI_B2,BMI_B2] = get_SMIBMI_v2(rB2_all,area_index,AP_index,nBoot,'B2');

if isSave==1
    save('Index_Boot_v2_highBF','SMI_A','SMI_B1','SMI_B2','BMI_A','BMI_B1','BMI_B2','nBoot');
end
