...
% smi
subplot(2,3,1);
plot_index(tpos,smi_a_p,line_color(1,:)); hold on
plot_index(tpos,smi_a_n,line_color(2,:));
plot_index_boot(tpos,SMI_A.boot);
xlabel('triplet position'); ylabel('log(CI)');
title('L');
box off
subplot(2,3,2);
plot_index(tpos,smi_b1_p,line_color(1,:)); hold on
plot_index(tpos,smi_b1_n,line_color(2,:));
plot_index_boot(tpos,SMI_B1.boot);
xlabel('triplet position'); ylabel('log(FSI)');
title('H1');
box off
subplot(2,3,3);
plot_index(tpos,smi_b2_p,line_color(1,:)); hold on
plot_index(tpos,smi_b2_n,line_color(2,:));
...
% bmi
subplot(2,3,4);
plot_index(tpos,bmi_a_p,line_color(1,:)); hold on
plot_index(tpos,bmi_a_n,line_color(2,:));
plot_index_boot(tpos,BMI_A.boot);
xlabel('triplet position'); ylabel('BMI');
title('L');
box off
subplot(2,3,5);
plot_index(tpos,bmi_b1_p,line_color(1,:)); hold on
plot_index(tpos,bmi_b1_n,line_color(2,:));
plot_index_boot(tpos,BMI_B1.boot);
xlabel('triplet position'); ylabel('BMI');
title('H1');
box off
subplot(2,3,6);
plot_index(tpos,bmi_b2_p,line_color(1,:)); hold on
plot_index(tpos,bmi_b2_n,line_color(2,:));
