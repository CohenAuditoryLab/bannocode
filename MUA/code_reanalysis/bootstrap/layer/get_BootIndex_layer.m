function [smi,bmi] = get_BootIndex_layer(rALL,i_depth,nBoot)
...
[smi_sup(1,i_tpos),bmi_sup(1,i_tpos)] = calc_Index(Rmat_s);
[smi_grn(1,i_tpos),bmi_grn(1,i_tpos)] = calc_Index(Rmat_g);
[smi_inf(1,i_tpos),bmi_inf(1,i_tpos)] = calc_Index(Rmat_i); 
...
%     Rmat_resample = resample_Rmat_v0(Rmat);
    ...
    [smi_boot_sup(n,i_tpos),bmi_boot_sup(n,i_tpos)] = calc_Index(Rmat_resample_s);
    [smi_boot_grn(n,i_tpos),bmi_boot_grn(n,i_tpos)] = calc_Index(Rmat_resample_g);
    [smi_boot_inf(n,i_tpos),bmi_boot_inf(n,i_tpos)] = calc_Index(Rmat_resample_i);
end
