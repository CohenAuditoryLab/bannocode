function [SMI_layer,BMI_layer] = get_SMIBMI_layer(rALL_ABB,area_index,AP_index,depth_index)
...
[smi_core,bmi_core] = get_BootIndex_layer(r_core,i_core,1); % core
[smi_belt,bmi_belt] = get_BootIndex_layer(r_belt,i_belt,1); % belt
[smi_post,bmi_post] = get_BootIndex_layer(r_post,i_post,1); % posterior
[smi_ant,bmi_ant] = get_BootIndex_layer(r_ant,i_ant,1);  % anterior
