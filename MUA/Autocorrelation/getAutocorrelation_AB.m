...
%   get autocorrelation of MUA
%   The correlation at time lag of 225 ms (A rate) and 150 ms (B rate) is
%   subtracted by correlation at time lag of 112 ms (null rate)
...
ACF_N_Lag = ACF_ST( N_Lag(1)-200:N_Lag(size(N_Lag,1))+200, : );
Min_ACF_N_Lag = min( ACF_N_Lag, [], 1 );%Get Min value within null_Lag interval

Max_ACF_A_Lag = Max_ACF_A_Lag - Min_ACF_N_Lag;
Max_ACF_B_Lag = Max_ACF_B_Lag - Min_ACF_N_Lag;
