...
DATA_DIR = fullfile('/Volumes/TOSHIBA_EXT/01_STREAMING/MUA/Results',RecordingDate,'ACF');
f_name = strcat(RecordingDate,'_ACF');
...
% save figures...
fig_name = strcat(RecordingDate,'_ACF_Arate_channel');
saveas(h_a(1),fullfile(DATA_DIR,fig_name),'png');
fig_name = strcat(RecordingDate,'_ACF_Arate_stdiff');
saveas(h_a(2),fullfile(DATA_DIR,fig_name),'png');

fig_name = strcat(RecordingDate,'_ACF_A&Brate_channel');
saveas(h_b(1),fullfile(DATA_DIR,fig_name),'png');
fig_name = strcat(RecordingDate,'_ACF_A&Brate_stdiff');
saveas(h_b(2),fullfile(DATA_DIR,fig_name),'png');

fig_name = strcat(RecordingDate,'_ACF_ABcomp_channel');
saveas(h_d(1),fullfile(DATA_DIR,fig_name),'png');
fig_name = strcat(RecordingDate,'_ACF_ABcomp_stdiff');
