% function [ stIndex, chDepth ] = getStreamingIndexSignificance_ACF( RecordingDate, nChannel, L3_ch, isSave )
...
th = 1.645; % 95% significance (one-sided)
% th = 2.33; % 99% significance (one-sided)
