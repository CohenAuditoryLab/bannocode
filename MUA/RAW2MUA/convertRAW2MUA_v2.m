...
root_file_dir = 'E:\01_Research\01_STREAM_INTEGRATION&SEGREGATION\DATA';
raw_file_dir = fullfile(root_file_dir,animal_name,'RAW'); % directory where raw files are stored...
mua_file_dir = fullfile(root_file_dir,animal_name,'MUA'); % directory where mua files are saved...
