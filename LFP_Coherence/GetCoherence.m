...
cfg.taper     = 'dpss';
cfg.output    = 'fourier';
cfg.tapsmofrq = 2; %bandwidth of 4 Hz (+-2) smoothing...
% cfg.pad       = 'nextpow2';
...
% % 
% % S_c = reshape(freq_c.fourierspctrm,nTrial_c,nTaper_c,nCh,nFreq);
% % S_w = reshape(freq_w.fourierspctrm,nTrial_w,nTaper_w,nCh,nFreq);
% % S_c = squeeze(mean(S_c,2));
% % S_w = squeeze(mean(S_w,2));
% % 
% % freq_c.fourierspctrm = S_c;
% % freq_w.fourierspctrm = S_w;
