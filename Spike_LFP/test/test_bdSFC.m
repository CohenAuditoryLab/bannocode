clear all;
% calculate spike-field coherence by using bipolar derivated LFP
...
rec_date = '20180727';
cl = 83; %73
ch = []; %10; % use cluster channel if empty...
...
fName_lfp = strcat(rec_date,'_ABBA_bdLFP'); % bipolar derivation
...
raster_cl = Raster(iBehav==1,:,idx); % choose responding unit
...
ch = ch - 1; % channel number should be shifted by 1 for bipolar derivation LFP...
lfp_ch = squeeze(bdLFP(ch,:,iBehav==1)); % choose channel 10 for test
