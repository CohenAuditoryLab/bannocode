clear all;
% calculate LFP spectrum by using bipolar derivated LFP
...
ch_bdLFP = ch-1; % channel number should be shifted by 1 for bipolar derivation LFP...
lfp_ch = squeeze(bdLFP(ch_bdLFP,:,iBehav==0)); % choose channel 10 for test
