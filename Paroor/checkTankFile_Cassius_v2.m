...
% Block = '~20200917_ABBA_test';
Block = '~20210205_Test';
% FileName_LabVIEW = 'cassius_frq_dynamic_2020091701';
FileName_LabVIEW = 'test_20210205';
DataTimeRange = [-0.5 3.5];
% DelayStimOn = -2.5e-3; % actual onset of the stimulus is ~2.5 ms before the estimated time
DelayStimOn = -1.5e-3; % actual onset of the stimulus is ~1.5 ms before the estimated time

% set global variables (should NOT change)
% TANK_FILE_DIR = 'F:\TDT\Synapse\Tanks\Domo-190417';
% TANK_FILE_DIR = 'D:\TDT\Tanks\Cassius-200917';
TANK_FILE_DIR = 'D:\TDT\Tanks\Cassius-210205';
STORE_NAME = 'Stm/';
...
t_stim = t_stim * 1000;
t_hand = t_hand * 1000;
stim_threshold = 0.0023; %0.0052; % must be larger than check_th_val
% stim_threshold = std(stim_noNoise(calib_window(1):calib_window(2))) * 5.0; % should be ~0.0023
% lever_threshold = 1.82; %0.39;
...
save_file_name = [date '_ABBA_BehavData_test2.mat'];
