...
addpath(genpath('C:\Users\Cohen\multichannel_sorting\KiloSort2_5')) % path to kilosort folder
...
chanMapFile = 'chanMap_vprobe16ch_v3.mat';

ops.trange    = [0 Inf]; % time range to sort
ops.NchanTOT  = 16; % total number of channels in your recording

run(fullfile(pathToYourConfigFile, 'config_domo_16ch_KS2_5.m'))
...
root_save = 'G:\Domo\Kilosort\KS2_5';
