...
ops.fbinary             = 'C:\work\continuous.dat'; % will be created for 'openEphys'		
ops.fproc               = 'C:\work\temp_wh.dat'; % residual from RAM of preprocessed data		
ops.root                = 'C:\work'; % 'openEphys' only: where raw files are		


%% options for channels and clustering
ops.fs       = 24414.0625; % 24414; % sampling rate fixed on 5/9/19
ops.NchanTOT = 16; % total number of channels
ops.Nchan    = 16; % num active channels
ops.Nfilt    = 4*16;  % num clusters to use (2-4x Nchan, multiple of 32)
...
ops.chanMap = 'C:\work\chanmap_domo.mat';
